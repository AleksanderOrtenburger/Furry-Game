...
function Game(){
    ...
    this.hideVisibleFurry = function(){
        var clone = document.querySelector("div.furry");
        if(clone !== null){
    ...
    this.checkCoinCollision = function(){
        if(this.furry.x === this.coin.x && this.furry.y === this.coin.y){
            ...
            var scoreCount = document.querySelector("#score strong");
    ...
    this.gameOverScreen = function () {
        ...
        sectionOver.lastElementChild.innerHTML = "GAME OVER <br> <strong>SCORE: "+this.score+"</strong>";
